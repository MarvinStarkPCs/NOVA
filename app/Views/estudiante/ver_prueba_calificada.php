...
<head>
  ...
  <style>
    ...
    nav { background: linear-gradient(90deg, #1a5aa2, #2a6322); color: white; padding: 15px 20px; font-size: 1.2rem; font-weight: bold; display: flex; align-items: center; gap: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.15);}
